...
A word of caution here. QED classes, when compiled into JS code, generate Javascript classes as well. When using embedded JS code in a class and refer to one of its members, use the `this` pointer.
