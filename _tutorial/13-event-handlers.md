...
The event can be more complex than a basic predefined type; just define the class return type as another sophisticated class with many the fields you need and use `return new ReturnTypeClass(field1, field2, ...)`.
{: .notice--info}
