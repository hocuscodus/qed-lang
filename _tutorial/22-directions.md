...
{% include sandboxframe.html qedsrc="directions1.qed" code="50" gui="100" height="200px" %}
...
{% include sandboxframe.html qedsrc="directions2.qed" code="50" gui="100" height="200px" %}
