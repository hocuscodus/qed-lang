...
{% include sandboxframe.html qedsrc="expand4.qed" code="65" gui="97" height="170px" %}
...
{% include sandboxframe.html qedsrc="expand5.qed" code="65" gui="97" height="150px" %}
...
{% include sandboxframe.html qedsrc="expand6.qed" code="65" gui="97" height="150px" %}
...
{% include sandboxframe.html qedsrc="expand7.qed" code="65" gui="97" height="170px" %}
...
{% include sandboxframe.html qedsrc="expand8.qed" code="65" gui="97" height="150px" %}
...
{% include sandboxframe.html qedsrc="expand9.qed" code="65" gui="97" height="150px" %}
...
{% include sandboxframe.html qedsrc="expand10.qed" code="65" gui="97" height="150px" %}
...
{% include sandboxframe.html qedsrc="expand11.qed" code="78" gui="97" height="110px" %}
...
{% include sandboxframe.html qedsrc="expand12.qed" code="65" gui="97" height="170px" %}
...
{% include sandboxframe.html qedsrc="expand13.qed" code="65" gui="97" height="170px" %}
...
{% include sandboxframe.html qedsrc="expand14.qed" code="65" gui="97" height="500px" %}
