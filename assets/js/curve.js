...
function _refresh (obj, x, y, width, height) {
  ...
  if (!Main_$this.fast || level != RefreshLevel.NONE) {
    ctx.globalAlpha = 1.0;

    if (!Main_$this.fast || level >= RefreshLevel.RESIZE) {
      if (!Main_$this.fast || !Main_$this.windows)// || !Main_$this.windows.length)
  ...
  constructor(ContentFn, context__Call) {
    ...
    this.refresh_Model_ = function () {
      if (!QedGenericButton$this.qedModel) {
        let u1 = new Main_$this.Directive_(0, new Main_$this.QEDExplicitArray(new Main_$this.Attr_(0, 0, 0, null), new Main_$this.Attr_(-1, 0, -1, (function W617$_ () {
          {
            QedGenericButton$this.pressed[0] = true;
            _captureFocus();
          }
        })), new Main_$this.Attr_(-2, 0, -1, (function W618$_ () {
          {
  ...
  constructor(Init, numDim, dirs, Ui_) {
        ...
        new (function W648$_ (i636$_) {
          ...
          if (InsertLevel$this.level < SQEDArray$this.dims.length - 1) {
            ...
            }
            {
              ...
              (function while645$_ () {
                if (pp[level] < pos[level] + InsertLevel$this.size[level]) {
                  InsertLevel$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.Init(InsertLevel$this.pp, InsertLevel$this.context__Call), (function Lambda_ (_ret646$_) {
                    if (!InsertLevel$this._isActive())
                      return;
                    InsertLevel$this._qedEndCall();
                    array[pp[level]] = _ret646$_;
                    pp[level]++;
                    while645$_();
                  })));
                }
    ...
    this.Push = class Push extends QEDObject {
      constructor(context__Call) {
        ...
        this.size[0] = 1;
        Push$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.Insert(this.pos, this.size, Push$this.context__Call), (function Lambda_ (_ret652$_) {
...
this.paintView = function (viewObj, posx, posy, sizex, sizey) {
};
  ...
  this.paint = function (pos0, pos1, size0, size1) {
    ...
    let size = new Main_$this.QEDExplicitArray(size0, size1);
    {
      ...
      while(index < length) {
        ...
        ViewArray_$this.paintViewFn(ViewArray_$this.array[index], pos[0], pos[1], size[0], size[1]);
        index++;
      }
    }
  };
...
this.paintViewObj = function (viewObj, posx, posy, sizex, sizey) {
  let window = viewObj;
  if (window.size())
...
this.paintViewString = function (viewObj, posx, posy, sizex, sizey) {
...
this.paintViewImage = function (viewObj, posx, posy, sizex, sizey) {
    ...
    if (outType >= 0 && directive.outAttr[0].value != null)
      if (outNumDim) {
        ...
        if (outType === 0) {
          let window = Widget_$this.outWidget;
          if (window.size())
            window[0].paint(pos0, pos1, size0, size1);
        }
        else
          if (outType === 1)
...
this.Main = class Main extends QEDObject {
  constructor(argv, context__Call) {
    ...
    this.Circle = class Circle extends QEDObject {
      constructor(i, context__Call) {
        super(context__Call);
        this.i = i;
        const Circle$this = this;
        this.refresh_Model_ = function () {
          if (!Circle$this.qedModel) {
            let u1 = new Main_$this.Directive_(0, new Main_$this.QEDExplicitArray(new Main_$this.Attr_(0, 0, 3, null), new Main_$this.Attr_(1, 0, 1, null), new Main_$this.Attr_(10, 1, -1, null)), new Main_$this.QEDExplicitArray());
            Circle$this.qedModel = new Main_$this.QEDExplicitArray(u1);
          }
          let u1 = Circle$this.qedModel[0];
          u1.clearChange();
          u1.setAtt(0, Main_$this.oval);
          u1.setAtt(1, 6);
          u1.setAtt(2, new Main_$this.QEDExplicitArray(Circle$this.x, Circle$this.i * 3.750000));
          let lvl = u1.refreshChange();
          let _level = lvl;
          return _level;
        };
        this.x = 250;
        (function while767$_ () {
          Circle$this._qedSetBlockingCall(_bindHandler(new Main_$this.QedYield(Circle$this.context__Call), (function Lambda_ (_ret768$_) {
            if (!Circle$this._isActive())
              return;
            Circle$this._qedEndCall();
            if (_ret768$_) {
              Circle$this.x = 250 - 10 + 100 * Main_$this.cos(Main$this.t / (512 + 4 * Circle$this.i));
              while767$_();
            }
            else
              Circle$this.qedModel = null;
          })));
        })();
      }
    };
    this.refresh_Model_ = function () {
      if (!Main$this.qedModel) {
        ...
        let u2 = new Main_$this.Directive_(0, new Main_$this.QEDExplicitArray(new Main_$this.Attr_(0, 1, 0, null)), new Main_$this.QEDExplicitArray());
        Main$this.qedModel = new Main_$this.QEDExplicitArray(u1, u2);
      }
      let u2 = Main$this.qedModel[0];
      u2.clearChange();
      u2.setAtt(0, new Main_$this.QEDExplicitArray(800, 480));
      let lvl = u2.refreshChange();
      let _level = lvl;
      let u1 = Main$this.qedModel[1];
      u1.clearChange();
      u1.setAtt(0, Main$this.line);
      u1.refreshOutModel();
    ...
    this.t = 0;
    this.line = (function init$Array () {
      let _d0 = 128;
      return (new Main_$this.QEDArray((function l (pos) {
        let i = pos[0];
        return (new Main$this.Circle(i, Main$this));
      }), 1, new Main_$this.QEDExplicitArray(0, 0), Main_$this.Qui_).insert(new Main_$this.QEDExplicitArray(0), new Main_$this.QEDExplicitArray(_d0)));
    })();
    _bindHandler(new Main_$this.QedInterval(16, Main$this), (function Lambda_ () {
      if (!Main$this._isActive())
        return;
      {
        Main$this.t += 16;
        Main_$this.qedResume(Main$this.line);
      }
    }));
    this.qedModel = null;
  }
