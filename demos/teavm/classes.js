...
function LO(a){var b;Db_$callClinit();Dzc=B3b(Q5b().getElementById("select"));Ezc=Q5b().getElementById("examples");Yyc=B3b(Q5b().getElementById("canvas"));Azc=B3b(Yyc.getContext("2d"));Zyc=B3b(Q5b().getElementById("code"));Czc=Q5b().getElementById("stdout");TFb();b=Qxc();Yyc.addEventListener("mousedown",G2b(b,"handleEvent"));Yyc.addEventListener("mouseup",G2b(b,"handleEvent"));Q5b().getElementById("run").addEventListener("click",G2b(Rxc(),"handleEvent"));if(C(Efb($rt_str(Zyc.value)))!=0){Lfb();}}
