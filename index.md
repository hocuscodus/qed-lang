...
Academically, the goal of QED is to substantiate how simple concepts such as function call and class instantiation can lead up to more sophisticated topics such as concurrency and GUI design, hence the QED name (Q.E.D. means "quod erat demonstrandum" or "that which was to be demonstrated" and is not related to type theory in our context). Practically though, the real goal is to simplify your life as a software developer by providing more power to your lines of code (or the same power for *less* lines of code).
